...
abstract public class AbstractChecksum implements Checksum {
    ...
    public void update(byte b) {
        //System.err.println("WARN: Suspicious update used!");
        update((int) (b & 0xFF));
    }
    ...
    public final String format(String format) {
        ...
        StringBuilder temp = new StringBuilder(format);
        firstFormat(temp);
     ...
     */
    public final long readFile(String filename) throws IOException {
